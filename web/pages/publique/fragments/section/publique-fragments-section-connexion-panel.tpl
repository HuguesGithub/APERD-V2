				...
				<div class="card-body">
					<form action="/admin/" method="post">
						...
						<div class="input-group mb-3">
							...
							<div class="input-group-append">
								<div class="input-group-text" style="padding-top: 10px; padding-bottom: 10px;"><span class="fa-solid fa-lock"></span></div>
							</div>
						</div>
						<div class="row">
							<div class="col-8 d-none d-xl-block"></div>
							<div class="col-xs-12 col-lg-4"><button type="submit" class="btn btn-primary btn-block">Valider</button></div>
						</div>
					</form>
				</div>
			</div>
