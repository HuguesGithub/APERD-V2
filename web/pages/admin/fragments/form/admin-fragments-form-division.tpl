        	...
        	<div class="row">
          		<div class="col-md">
            		<div class="form-floating mb-3">
              			<input id="labelDivision" type="text" class="form-control form-control-sm" placeholder="Libellé" value="%5$s" name="labelDivision">
              			<label for="labelDivision">Libellé</label>
            		</div>
          		</div>
        	</div>
        </div>
